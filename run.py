...
if len(sys.argv)>1 and (sys.argv[1] == 'train' or sys.argv[1] == 'extratrain'):
    ...
    nmt = model.NMTmodel(embedding_size, hidden_size, num_layers, dropout, attention_size, sourceWord2ind, targetWord2ind, startToken, endToken, unkToken, padToken).to(device)
